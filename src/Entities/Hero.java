...
public abstract class Hero {
    ...
    /**
     * Copy constructor for creating a new Hero instance that is a copy of another Hero.
     *
    ...
    public Hero(Hero other) {
        ...
        this.mainWeapon = new MainWeapon(other.mainWeapon);
        this.inventory = new ArrayList<>();
        this.boughtItems = new ArrayList<>();
    }
    ...
    public abstract Hero copy(); // Abstract copy method
}