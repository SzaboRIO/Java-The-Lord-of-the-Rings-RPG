...
public class MiddleEarth {
    ...
    private ArrayList<NPC> miniBosses = new ArrayList<>();
    private final ArrayList<NPC> initialMiniBosses = new ArrayList<>();
    ...
    private void initializeEnemies() {
        ...
        initialMiniBosses.addAll(miniBosses);
    }
    ...
    public void start() throws FileNotFoundException, InterruptedException {
        ...
        System.out.println();
        Ascii.printFile("AsciiFiles/vendor.txt");
        Audio.playMusic("AudioFiles/vendor.wav");
    ...
    private void encounterEnemy(NPC enemy) throws FileNotFoundException, InterruptedException {
        Audio.playMusic("AudioFiles/normalenemy.wav");
    ...
    private void encounterMiniBoss() throws FileNotFoundException, InterruptedException {
        ...
        Audio.playMusic("AudioFiles/minibossfight.wav");
    ...
    /**
     * Handles the scenario when the hero dies in battle.
     * Plays the death music and animation, then prompts the player with options:
     * 1. Play again with the same character (resets the game state)
     * 2. Create a new character (starts a new game)
     * 3. Exit the game
     *
     * @throws FileNotFoundException If the death ASCII art file is not found.
     * @throws InterruptedException If the thread is interrupted while handling death.
     */
    private void handleDeath() throws FileNotFoundException, InterruptedException {
        Audio.playMusic("AudioFiles/death.wav");
        System.out.println("You have been defeated! Game Over.");
        System.out.println();
        Ascii.printFile("AsciiFiles/death.txt");
        sleep(4000);
        ...
        while (!validChoice) {
            System.out.println("\nDo you want to:");
            System.out.println("[1] Play again with the same character");
            ...
            try {
                ...
                switch (choice) {
                    case 1:
                        hero = Game.getSavedHero();
                        if (hero == null) {
                            System.out.println("No saved hero found. Creating a new character.");
                            hero = createCharacter();
                        }
                        validChoice = true;
                        System.out.println("\n✨ You have been restored!");
                        miniBosses.clear();
                        miniBosses.addAll(initialMiniBosses);
    ...
    private void postBattleMenu() throws FileNotFoundException, InterruptedException {
        while (true) {
            Audio.playMusic("AudioFiles/postbattle.wav");
            System.out.println("\nPost-Battle Options:");
    ...
    public void finalBossBattle() throws FileNotFoundException, InterruptedException {
        Audio.playMusic("AudioFiles/sauronfight.wav");
