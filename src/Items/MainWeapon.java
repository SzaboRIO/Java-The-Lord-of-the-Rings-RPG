...
public class MainWeapon extends Item{
    ...
    /**
     * Copy constructor for creating a new MainWeapon instance that is a copy of another MainWeapon.
     *
     * @param other The MainWeapon object to copy
     */
    public MainWeapon(MainWeapon other) {
        super(other.name, other.cost); // Call the superclass (Item) constructor
        this.type = other.type;
        this.attackPower = other.attackPower;
        this.specialEffect = other.specialEffect;
        this.specialEffectType = other.specialEffectType;
        this.effectChance = other.effectChance;
        this.effectTarget = other.effectTarget;
