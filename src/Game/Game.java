...
public class Game {
    ...
    public static Hero createCharacter() throws FileNotFoundException {
        ...
        Ascii.printFile("AsciiFiles/gamestart.txt");
        Audio.playMusic("AudioFiles/gamestart.wav");
        ...
        Hero createdHero = hero;
        savedHero = createdHero.copy();

        return hero;
    }

    public static Hero getSavedHero() {
        return savedHero;
    }
}